...
$sql = "
    ...
    WHERE cc.name LIKE :category1 OR cc.name LIKE :category2 OR cc.name LIKE :category3 OR cc.name LIKE :category4 OR cc.name LIKE :category5";
$params = [
    'userid' => $userid,
    'category1' => '%(GCPV)%',
    'category2' => '%(GCBS)%',
    'category3' => '%(SAPS)%',
    'category4' => '%Vocational%',
    'category5' => '%Miscellaneous%'
];
