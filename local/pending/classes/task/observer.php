    ...
    public static function group_member_removed(\core\event\group_member_removed $event)
    {
        ...
        if (is_enrolled($coursecontext, $relateduserid)) {
            ...
            {      
                ...
                $select = 'fieldid = 6 AND userid = :userid';   //declaring variable in mysql search
            ...
            //-----------------------------------------------Email Templates-------------------------------------------------
                ...
                if ($LLN == 'pending')
                {
                    ...
                    <p>You can access your LLN quiz through the course portal <a href="https://www.gsestraining.com/course/view.php?id='.$courseid.'">here</a></p>
                    <br />
                ...
                else
                {
                    ...
                    <p>You can access your course through the course portal <a href="https://www.gsestraining.com/course/view.php?id='.$courseid.'">here</a></p>
                    <br />
                    <p>If you are having troubles accessing the course or have any further questions, please don\'t hesitate to contact us!</p>
                    <br />
                    <br />
